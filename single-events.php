                  ...
                  <div class="popupin">
                     ...
                     <div class="new-vert">
                        <div class="new-horiz-spleet vom">
                           <div class="new-info-line">
                              <div class="new-vert-24 mmax265">
                                 ...
                                 <div class="new-vert-4">
                                    <div class="new-p-18-21 upper"><?php if ( ! empty( get_field( 'start_date', false ) ) ) : ?><span><?php echo get_field( 'start_date', false ); ?></span><?php endif; ?> — <?php if ( ! empty( get_field( 'end_date', false ) ) ) : ?><span><?php echo get_field( 'end_date', false ); ?></span><?php endif; ?></div>
                           ...
                           <?php $link = get_field( 'ccylka_na_meropriyatie', false );
                              if ( ! empty( $link ) ) :
                              			$url = $link['url'];
                              			$title = $link['title'];
