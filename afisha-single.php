			...
			<div class="barba-container afisha-body">
				<div class="page-wrap afisha-page hp2">
					<div class="main-wrap events-single">
						<div class="popupin">
							<div class="new-vert vert-bottom new-top-block back-btn-bloack">
								<div class="new-div-104"></div><a href="#" class="new-back-btn w-inline-block"><div class="new-scg17 w-embed"><svg width="100%" height="100%" viewbox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.67486 15.3986L9.63207 15.4414L6.74035 15.4414L1.00031 9.70137L1.00031 6.44417L6.73991 0.704566L9.6325 0.704566L9.67485 0.746916L3.40203 7.01974L17 7.01974L17 9.125L3.40124 9.125L9.67486 15.3986Z" fill="#282828"></path></svg></div><div>Вернуться назад</div></a>
								<div class="new-div-104"></div>
							</div>
							<div class="new-vert vert-bottom new-top-block">
								<div class="new-horiz"><img src="<?php echo get_template_directory_uri() ?>/images/67b46b85bcb831d14ecb7b5e_Frame20178.svg" loading="lazy" alt class="newicon48">
									<div class="new-p-18-21">Выставка<br>Современное искусство</div>
								</div>
								<h1 class="new-h1-72">Теорема Дождя. Алексей Каллима</h1>
							</div>
							<div class="new-div-104"></div>
							...
							<div class="new-vert event-line">
								<div class="new-line-event-spleet">
									<div class="new-p-36-32 mmax638">Проект отличается не традиционным кураторским решением: зрителю предлагается самостоятельно найти связи</div><img src="<?php echo get_template_directory_uri() ?>/images/67b46d9fe17c2fb46ebdacf4_Frame201321316681.jpg" loading="lazy" alt class="new-img-171-171"></div>
								<div class="new-vert-6">
									<div class="new-p-16-19">Критик</div>
									<div class="new-p-20-24">Наталья Григорьева-Литвинская</div>
								</div><img src="<?php echo get_template_directory_uri() ?>/images/67b46d9fe17c2fb46ebdacf4_Frame201321316681.jpg" loading="lazy" alt class="new-img-171-171 non"></div>
							<div class="new-div-104"></div><img src="<?php echo get_template_directory_uri() ?>/images/67b46e5093d7019a1385c2ff_Rectangle20226.jpg" loading="lazy" alt class="img-fw">
							<div class="new-div-104"></div>
							<div class="new-vert">
								<div class="new-horiz-spleet">
									<div class="new-p-20-24 mmax545">Выставка о влиянии творчества Казимира Малевича на искусство ХХ века и о взаимодействии зрителя с произведением и произведения со зрителем.</div>
									<div class="new-vert-24">
										<div class="new-p-16-19">Особенности</div>
										<div class="new-p-16-19 colorer">На выставке можно увидеть работы Казимира Малевича, Сая Твомбли, Эрика Булатова, Энди Уорхола и других художников международного значения</div>
									</div>
								</div>
							</div>
							<div class="new-div-104"></div>
					...
					<div class="nav-bottom">
						<div class="container nav-container"><a data-if-exists="true" data-acf-link="menyu_o_proekte" data-acf-context="option" href="/about" class="nav-link cursor-hover">о проекте</a><a href="/afisha" class="nav-link cursor-hover">афиша</a>
							<div data-query-arg-posts_per_page="1" data-wp="wp_query" data-query-arg-post_type="magazine"><a data-wp="post_link" href="/magazine3" class="nav-link cursor-hover w-inline-block"><div data-if-exists="true" data-acf="zhur_opc" data-acf-context="option">журнал</div></a></div>
						</div>
					</div>
					...
					<div class="mobmenu"><a data-lenis-toggle href="#" class="mob-btn w-inline-block"><div class="code-embed-2 w-embed"><svg width="100%" height="100%" viewbox="0 0 375 44" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M213.03 8.43015C220.813 15.4131 229.56 23 240.017 23H351C364.255 23 375 23 375 23V92C375 105.255 364.255 116 351 116H24C10.7452 116 0 105.255 0 92V23H24H135.983C146.44 23 155.187 15.4131 162.969 8.43014C168.811 3.18846 176.533 0 185 0H191C199.467 0 207.189 3.18847 213.03 8.43015Z" fill="black"></path><path d="M180 16.5H196M180 23.5H196" stroke="white" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="round"></path></svg></div></a>
						<div data-lenis-prevent class="mob-menu-line"><a href="/" class="menu-btn">BKSQ</a><a data-if-exists="true" data-acf-link="menyu_o_proekte" data-acf-context="option" href="/about" class="menu-btn">О проекте</a>
							<div data-query-arg-posts_per_page="1" data-wp="wp_query" data-query-arg-post_type="magazine"><a data-wp="post_link" href="#" class="w-inline-block"><div>Журнал</div></a></div><a data-if-exists="true" data-acf-link="menyu_biznes_soprovozhzhenie" data-acf-context="option" href="/b2b" class="menu-btn">Бизнес-сопровождение</a></div>
					</div>
				</div>
				<div class="hidden">
