<?php
/*
Template name: Журнал BKSQ №2(12) «Память—Архив—Коллекция»
*/
?>
    <!DOCTYPE html>
<html data-wf-page="6704f17061cf6aa78bd63b24" data-wf-site="6704f17061cf6aa78bd63b0e">
...
.startloaded .load-image{width:350rem;}
		...
		<div class="page-wrap">
			<div class="main-wrap">
				<section class="section magazine-hero-section is-orange-bg">
					<div class="container">
						<div class="hero-content magazine-hero-content">
							<div class="magazine-hero-caption">
								<div class="text-18 mob-18">BKSQ №2      Память   —  Архив  —  Коллекция</div>
							</div>
							<h1 class="h1 magazine-h1">Горизонт <span class="no-mob"> </span>событий     <br>и    <span class="no-mob">  </span> направление движения <span class="no-wrap-mob">в к</span>ультуре   <span class="no-wrap-tab no-wrap-mob">и   с</span>овременном искусстве</h1>
						</div>
					</div>
				</section>
						...
						<div class="content-block magazine-s2-content-block">
							<div class="magazine-s2-left-col scrollobs">
								<div class="gap-8 magazine-s2-text-box">
									...
									<p class="text-16 _14-tab">Май 2024</p>
								</div>
								<div class="gap-8 magazine-s2-text-box">
									<p class="text-16 is-opacity-60 _14-tab">Полосность</p>
									<p class="text-16 _14-tab">316</p>
								</div>
								<div class="gap-8 magazine-s2-text-box">
							...
							<div class="magazine-s2-image-column"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63bb7_magazine2.avif" loading="lazy" alt class="image-contain image-cover"></div>
							<div class="magazine-s2-right-col scrollobs">
								<p class="text-neue-44">BKSQ №2</p>
								<p class="text-16 _14-tab">Память  ——  Архив  ——  Коллекция: темы <br>номера можно увидеть как разные аспекты большого «разворота назад‎», наваждения прошлым, случившегося с нашим временем, и его проявлением в разных сферах системы искусства</p>
				...
				<section class="section magazine-s3-section">
					<div class="container">
						<div class="heading-wrap ms3-heading-wrap">
							<h2 class="h1 scrollobs">Коллекция <span class="no-tab">        </span>может определить <span class="from-tab no-mob">       </span>наше видение того, <span class="only-mob">   </span><span class="no-tab">        </span>что нужно <span class="no-tab">    <br></span>делать дальше</h2>
							<div class="magazine-s3-quote-info-box scrollobs">
						...
						<div class="content-block ms4-content-block">
							<div class="ms4-left">
								<div class="ms-4-left-top scrollobs">
									<p class="text-16 _14-tab">205 — 215</p>
									<div class="heading-wrap ms4-heading-wrap">
										<h2 class="h2">Мода смотрит назад, как в старом фильме, — было <span class="no-wrap-tab no-wrap-mob">это или</span> нет?</h2>
									</div>
								</div>
								<div class="ms-4-left-bottom scrollobs">
									<div class="ms4-text-grid">
										<p class="text-16 _14-tab">В ЭТОМ НОМЕРЕ речь идет о том, как искусство занимается работой с памятью, пытаясь деконструировать ее, исследовать символику коллективной памяти, коды национальных мифов, выявить и описать травму и следы, которые она оставляет; как музеи выстраивают архивы, и художники — работают с ними; как выбор коллекционеров в итоге определяет линию развития искусства.</p>
										<p id="w-node-_95efbdf8-9de4-0953-a3fa-65e655080c1e-8bd63b24" class="text-16 _14-tab">ЕЩЕ ОДИН важный тэг, который проходит сквозь весь номер — тема искусства как исследования — тоже, конечно, прямо связанная с архивным поворотом.<br><br>А ЕСЛИ ГОВОРИТЬ о практических вещах, стартовой точкой всего нашего номера стала не теория, а тот очевидный момент, который переживает российский рынок искусства. Где, и это стало очень заметно в последний год, пробил (наконец) час коллекционера.</p>
									</div>
									<p class="text-14 is-opacity-60 is-uppercase">Из письма главного редактора Black Square, <br>Анзора Канкулова</p>
								</div>
							</div>
							<div class="ms4-right scrollobs">
								<div class="ms4-image-box cursor-hover"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b49_magazine.avif" loading="lazy" alt class="ms4-image"></div>
							</div>
						</div>
					</div>
				</section>
						...
						<div class="content-block ms5-content-block">
							<div class="ms5-box cursor-hover scrollobs">
								<div class="ms5-image-row">
									<div class="ms5-image ms5-image-double"><img src="<?php echo get_template_directory_uri() ?>/images/6718b325be43b10b77cbf181_Frame201321316495-min.avif" loading="lazy" alt class="image-cover"></div>
								</div>
								<div class="ms5-box-bottom">
									<div class="ms5-box-bottom-left mw-278">
										<p class="text-16">Маша Смирнова, основательница марки InShade показывает, из каких вдохновений складываются<br>ее коллекции</p>
									</div>
									<div class="ms5-box-bottom-right">
										<p class="text-16 _14-tab _2">58 — 59</p>
									</div>
								</div>
							</div>
							<div class="ms5-box cursor-hover scrollobs">
								<div class="ms5-image-row">
									<div class="ms5-image ms5-image-double"><img src="<?php echo get_template_directory_uri() ?>/images/6718b34ee7ef50fa1bcc2869_Frame201321316496.avif" loading="lazy" alt class="image-cover"></div>
									<div class="ms5-image ms5-image-double"><img src="<?php echo get_template_directory_uri() ?>/images/6718b34e59e02ec07efde73a_Frame201321316497.avif" loading="lazy" alt class="image-cover"></div>
								</div>
								<div class="ms5-box-bottom">
									<div class="ms5-box-bottom-left mw-550">
										<p class="text-16 is-opacity-60 is-uppercase">Сергей Гуськов</p>
										<p class="text-16 _14-tab">Часть архива, часть исследования, доля парадокса и щепотка странности, которая делает работы живыми, а Яна Гинзбурга – обсуждаемым художником моментa</p>
									</div>
									<div class="ms5-box-bottom-right">
										<p class="text-16 _14-tab _2">100 — 113</p>
									</div>
								</div>
							</div>
							<div class="ms5-box cursor-hover scrollobs">
								<div class="ms5-image-row">
									<div class="ms5-image"><img src="<?php echo get_template_directory_uri() ?>/images/6718b373c4a28d9760a86037_BLKSQR23220(2)-32B_page-0001.avif" loading="lazy" alt class="image-cover"></div>
									<div class="ms5-image ms5-image-double"><img src="<?php echo get_template_directory_uri() ?>/images/6718b37323942717af0181f3_Frame201321316498.avif" loading="lazy" alt class="image-cover"></div>
								</div>
								<div class="ms5-box-bottom">
									<div class="ms5-box-bottom-left mw-433">
										<p class="text-16 is-opacity-60 is-uppercase">Фото Андрей Кирсанов, редакторы моды Миша+Китти</p>
										<p class="text-16 _14-tab">Саша Сулим, шипы и лепестки, улики и секреты, <br>кожа и ткань. Съемка от Black Square</p>
									</div>
									<div class="ms5-box-bottom-right">
										<p class="text-16 _14-tab _2">186 — 201</p>
									</div>
								</div>
							</div>
							<div class="ms5-box cursor-hover scrollobs">
								<div class="ms5-image-row">
									<div class="ms5-image ms5-image-double"><img src="<?php echo get_template_directory_uri() ?>/images/6718b79ccc349b5798687a5e_Frame201321316503.avif" loading="lazy" alt class="image-cover"></div>
									<div class="ms5-image"><img src="<?php echo get_template_directory_uri() ?>/images/6718b7b3a635357c8c71e4d1_BLKSQR23220(2)-1_page-0003.avif" loading="lazy" alt class="image-cover"></div>
								</div>
								<div class="ms5-box-bottom">
									<div class="ms5-box-bottom-left mw-433">
										<p class="text-16 is-opacity-60 is-uppercase">Марина Федоровская</p>
										<p class="text-16 _14-tab">Жюльен Крезе, креолизация и коллективная память, павильон Франции на Венецианской Биеннале</p>
									</div>
									<div class="ms5-box-bottom-right">
										<p class="text-16 _14-tab _2">32 — 34</p>
									</div>
								</div>
							</div>
						</div>
				...
				<section class="section">
					<div class="vimeo-cursor-hover">
						<div data-w-id="3b21dbcf-607c-b553-4500-0e2ad8e6b99e" class="container full-width-container"><a style="-webkit-transform:translate3d(0, 0, 0) scale3d(0.7, 0.7, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(0.7, 0.7, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(0.7, 0.7, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(0.7, 0.7, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" href="https://vimeo.com/user225032781" target="_blank" class="video-block w-inline-block"><div class="mag-video"><div data-poster-url="https://cdn.prod.website-files.com/66d1698fdc27186621477475/66ed7fe4876aa0ad282997c2_IMG_2056 (1)-poster-00001.jpg" data-video-urls="https://cdn.prod.website-files.com/66d1698fdc27186621477475/66ed7fe4876aa0ad282997c2_IMG_2056 (1)-transcode.mp4,https://cdn.prod.website-files.com/66d1698fdc27186621477475/66ed7fe4876aa0ad282997c2_IMG_2056 (1)-transcode.webm" data-autoplay="true" data-loop="true" data-wf-ignore="true" class="background-video w-background-video w-background-video-atom"><video id="db427d5e-ed2f-5090-d41d-5b001f0e2dd1-video" autoplay loop style='background-image:url("https://cdn.prod.website-files.com/66d1698fdc27186621477475/66ed7fe4876aa0ad282997c2_IMG_2056 (1)-poster-00001.jpg")' muted playsinline data-wf-ignore="true" data-object-fit="cover"><source src="https://cdn.prod.website-files.com/66d1698fdc27186621477475/66ed7fe4876aa0ad282997c2_IMG_2056 (1)-transcode.mp4" data-wf-ignore="true"></source><source src="https://cdn.prod.website-files.com/66d1698fdc27186621477475/66ed7fe4876aa0ad282997c2_IMG_2056 (1)-transcode.webm" data-wf-ignore="true"></source></video></div></div></a></div>
					</div>
				</section>
				<section id="tochki-prodazh" class="section magazine-s6-section">
					<div class="container">
...
<label for="switcher2" class="switcher__label">Где почитать</label></div>
						...
						<div class="content-block magazine-s6-content-block scrollobs">
							<div class="ms6-left">
								<div class="text-18 mob-18">заказать журнал <span class="no-wrap">Black Square</span> в онлайн-магазинах</div>
							</div>
							<div class="ms6-right">
								<div data-acf-repeater="tochki_prodazh_pod_kartoj" class="ms6-link-wrap">
									<div class="div-block-9">
										<div class="ms6-arrow-link">
											<div data-if-exists="true" data-acf="nazvanie_magazina" class="text-neue-44 h-90">Ozon</div>
										...
										</div><a data-if-exists="true" data-acf-link="link" href="https://www.ozon.ru/product/zhurnal-black-square-novaya-geografiya-1303970739/?__rr=1" target="_blank" class="ms6-arrow-link abs w-inline-block"><div data-if-exists="true" data-acf="nazvanie_magazina" class="text-neue-44 h-90">Ozon</div><div class="ms6-link-arrow"><div class="svg w-embed"><svg width="100%" style viewbox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.6522 1.20666L14.7378 1.12109L20.5213 1.12109L32.0005 12.6003V19.1164L20.5221 30.5948H14.7369L14.6522 30.5101L27.1981 17.9643L0 17.9643V13.7537L27.1993 13.7537L14.6522 1.20666Z" fill="currentColor"></path></svg></div></div><div class="ms6-link-divider btns"></div></a></div>
									<div class="div-block-9">
										<div class="ms6-arrow-link">
											<div data-if-exists="true" data-acf="nazvanie_magazina" class="text-neue-44 h-90">Ozon</div>
											<div class="ms6-link-arrow">
      ...
      if (btnsGroup.children.length === 2) {
        ...
        form.addEventListener("submit", function () {
          newSubmitBtn.textContent = submitText;
									...
									<form id="email-form" name="email-form" data-name="Email Form" method="get" class="mag-form" data-wf-page-id="6704f17061cf6aa78bd63b24" data-wf-element-id="4d0bcac9-13f1-59b8-8666-f891b391d07a">
...
<input class="text-field w-input" maxlength="256" name="field" data-name="Имя" placeholder type="text" id="name"></div>
										<div id="w-node-_4d0bcac9-13f1-59b8-8666-f891b391d07f-8bd63b24" class="form-field-wrap">
...
<input class="text-field w-input" maxlength="256" name="field" data-name="Телефон" placeholder type="tel" id="phone" required></div>
										<div id="w-node-_4d0bcac9-13f1-59b8-8666-f891b391d083-8bd63b24" class="form-field-wrap">
...
<input class="text-field w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder type="email" id="email-2" required></div>
										<div id="w-node-_4d0bcac9-13f1-59b8-8666-f891b391d087-8bd63b24" class="form-field-wrap">
<label for="releases" class="field-label">Выпуски</label>
											<div class="w-embed">
<select id="releases" name="releases" data-name="releases" required multiple class="hidden-select w-select"> <option value="№1   Новая география">№1 Новая география</option> <option selected value="№2  Память—Архив—Коллекция">№2 Память—Архив—Коллекция</option> <option value="№3  Другие миры">№3 Другие миры</option> 
</select></div>
										...
										<div id="w-node-_4d0bcac9-13f1-59b8-8666-f891b391d09d-8bd63b24" class="form-field-wrap numeric">
<label for="quantity-2" class="field-label">Кол-во экземпляров</label>
<input class="text-field num w-input" maxlength="256" name="field" data-name="Кол-во экземпляров" placeholder type="number" id="quantity"></div>
										<div id="w-node-_4d0bcac9-13f1-59b8-8666-f891b391d0a1-8bd63b24" class="form-field-wrap">
...
<textarea class="text-area w-input" data-lenis-prevent maxlength="5000" name="field" data-name="Комментарий" placeholder id="comment"></textarea></div>
										<div id="w-node-_4d0bcac9-13f1-59b8-8666-f891b391d0a5-8bd63b24" class="form-field-wrap">
...
<input type="submit" data-wait="Оставить заявку" class="submit-button w-button" value="Оставить заявку"><a href="#" class="submit-button dot-link w-inline-block"><div class="text-18 mob-18">Оставить заявку</div></a></div>
			...
			<div class="nav-bottom">
				<div class="container nav-container"><a data-if-exists="true" data-acf-link="menyu_o_proekte" data-acf-context="option" href="/about" class="nav-link cursor-hover">о проекте</a><a href="#" class="nav-link cursor-hover hidden">афиша</a>
					<div data-query-arg-posts_per_page="1" data-wp="wp_query" data-query-arg-post_type="magazine"><a data-wp="post_link" href="/magazine2" aria-current="page" class="nav-link cursor-hover w-inline-block w--current"><div>журнал</div></a></div>
				</div>
			</div>
    ...
    background-color: var(--maincolor);
		...
		<div class="popup-wrapper see-all-popup-wrapper">
			...
			<div data-lenis-prevent class="see-all-popup">
				...
				<div class="see-all-popup-inner">
					...
					<div data-acf-repeater="popuplinks" class="see-all-grid"><a data-if-exists="true" data-acf-link="linkpopupbuy" id="w-node-_929622b3-614d-6665-096f-61246073a472-6073a471" href="https://www.respublica.ru/knigi/zhurnaly-i-gazety/1457734-zhurnal-black-square-2023-1-novaya-geografiya-novaya-logistika" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/67124a0e85200f17de634535_Frame201321315904.svg" loading="lazy" data-acf-image="imgpopupbuy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a474-6073a471" href="https://www.ozon.ru/product/zhurnal-black-square-novaya-geografiya-1303970739/?__rr=1" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b4e_all-1.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a476-6073a471" href="https://nuself.ru/products/zurnal_black_square_12023_6541/" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b5f_all-14.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a478-6073a471" href="https://shop.garagemca.org/ru/books/magazines-and-newspapers/black-square-12023-43841.html" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b58_all-6.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a47a-6073a471" href="https://shop.centrezotov.ru/brands/black-squre" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b5e_all-12.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a47c-6073a471" href="https://lobby.moscow/ru/store/product/black-square-1" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b5a_all-7.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a47e-6073a471" href="https://www.moscowbooks.ru/book/1174949/" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b51_all-2.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a480-6073a471" href="#" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b5c_all-8.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a482-6073a471" href="https://thedar.store/search/?q=black+square" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b4f_all-3.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a484-6073a471" href="https://dk-spb.ru/books/240540" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b60_all-9.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a486-6073a471" href="#" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b52_all-4.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a488-6073a471" href="https://perspektiva.film/booksandzines/tproduct/378275413-825723720551-zhurnal-black-square-1-2023-novaya-geogr" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b59_all-10.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a48a-6073a471" href="https://www.jewish-museum.ru/museum-shop/catalog/iskusstvo/zhurnal-black-square/?sphrase_id=101278" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b50_all-5.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a48c-6073a471" href="https://lebigmag.ru/search/?q=black+square" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b5d_all-11.avif" loading="lazy" alt class="image-contain"></a><a id="w-node-_929622b3-614d-6665-096f-61246073a48e-6073a471" href="https://www.masters-bookstore.ru/tproduct/666665389-159993251481-zhurnal-black-square-1" target="_blank" class="see-all-box w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b5b_all-13.avif" loading="lazy" alt class="image-contain"></a></div>
				</div>
			</div>
		</div>
			...
			<div class="mag-popup">
				...
				<div class="mag-popup-inner">
					<div class="mag-image-row single-image-row">
						<div class="mag-image-box"><img src="<?php echo get_template_directory_uri() ?>/images/6718b325be43b10b77cbf181_Frame201321316495-min.avif" loading="lazy" alt class="image-cover"></div>
					</div>
					<div class="mag-popup-bottom">
						<p class="text-16 _14-tab">Маша Смирнова, основательница марки InShade показывает, из каких вдохновений складываются ее коллекции</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="mag-popup">
				...
				<div class="mag-popup-inner">
					<div class="mag-image-row">
						<div class="mag-image-box"><img src="<?php echo get_template_directory_uri() ?>/images/6718b34ee7ef50fa1bcc2869_Frame201321316496.avif" loading="lazy" alt class="image-cover"></div>
						<div class="mag-image-box"><img src="<?php echo get_template_directory_uri() ?>/images/6718b34e59e02ec07efde73a_Frame201321316497.avif" loading="lazy" alt class="image-cover"></div>
					</div>
					<div class="mag-popup-bottom">
						<p class="text-18 is-opacity-60 is-uppercase">Сергей Гуськов</p>
						<p class="text-16 _14-tab">Часть архива, часть исследования, доля парадокса и щепотка странности, которая делает работы живыми, а Яна Гинзбурга – обсуждаемым художником моментa</p>
					</div>
				</div>
			</div>
		...
		<div class="popup-wrapper mag3-popup-wrapper mag">
			...
			<div class="mag-popup">
				...
				<div class="mag-popup-inner">
					<div class="mag-image-row">
						<div class="mag-image-box"><img src="<?php echo get_template_directory_uri() ?>/images/6718b373c4a28d9760a86037_BLKSQR23220(2)-32B_page-0001.avif" loading="lazy" alt class="image-cover"></div>
						<div class="mag-image-box"><img src="<?php echo get_template_directory_uri() ?>/images/6718b37323942717af0181f3_Frame201321316498.avif" loading="lazy" alt class="image-cover"></div>
					</div>
					<div class="mag-popup-bottom">
						<p class="text-18 is-opacity-60 is-uppercase">Фото Андрей Кирсанов, редакторы моды Миша+Китти</p>
						<p class="text-16 _14-tab">Саша Сулим, шипы и лепестки, улики и секреты, <br>кожа и ткань. Съемка от Black Square</p>
					</div>
				</div>
			</div>
		...
		<div class="popup-wrapper mag4-popup-wrapper mag">
			...
			<div class="mag-popup">
				...
				<div class="mag-popup-inner">
					<div class="mag-image-row">
						<div class="mag-image-box"><img src="<?php echo get_template_directory_uri() ?>/images/6718b79ccc349b5798687a5e_Frame201321316503.avif" loading="lazy" alt class="image-cover"></div>
						<div class="mag-image-box"><img src="<?php echo get_template_directory_uri() ?>/images/6718b7b3a635357c8c71e4d1_BLKSQR23220(2)-1_page-0003.avif" loading="lazy" alt class="image-cover"></div>
					</div>
					<div class="mag-popup-bottom">
						<p class="text-18 is-opacity-60 is-uppercase">Марина Федоровская</p>
						<p class="text-16 _14-tab">Жюльен Крезе, креолизация и коллективная память, <br>павильон Франции на Венецианской Биеннале</p>
					</div>
				</div>
			</div>
		</div>
		<div class="popup-wrapper mag5-popup-wrapper mag">
			...
			<div class="mag-popup">
				...
				<div class="mag-popup-inner">
					<div class="mag-image-row single-image-row">
						<div class="mag-image-box maxh-450"><img src="<?php echo get_template_directory_uri() ?>/images/6704f17061cf6aa78bd63b49_magazine.avif" loading="lazy" alt class="image-cover"></div>
					</div>
				</div>
			</div>
		</div>
