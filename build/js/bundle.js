...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AfishaFilterForm: () => (/* binding */ AfishaFilterForm)
/* harmony export */ });
...
class AfishaFilterForm {
  ...
  async getUserCity() {
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.promiseWrapper)(this.getUserLocation());
    console.log({
      data,
      error
    });
  ...
  onChange = async event => {
    ...
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.promiseWrapper)(this.fetchPosts());
    if (error) {
  ...
  onPreSelectedButtonClick = async event => {
    ...
    event.stopPropagation();
    let value = '';
    const config = JSON.parse(event.target.closest('button').dataset.jsAfishaFilterFormPreselectedButton);
    ...
    if (config.action) {
      const {
        data,
        error
      } = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.promiseWrapper)(this[config.action]());
      if (error) {
        return;
      }
      value = data;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCustomDatePicker: () => (/* binding */ initCustomDatePicker)
/* harmony export */ });
...
const initCustomDatePicker = () => {
  ...
  if (dateControl) {
    ...
    const calendar = (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"])(dateControl, {
      // altInput: true,
      mode: 'range',
      altFormat: 'F j, Y',
      enableYear: false,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCustomSelectComponents: () => (/* binding */ initCustomSelectComponents)
/* harmony export */ });
...
const initCustomSelectComponents = () => {
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AfishaFilterForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AfishaFilterForm */ "./src/AfishaFilterForm.js");
/* harmony import */ var _AfishaMap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AfishaMap */ "./src/AfishaMap.js");
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_AfishaMap__WEBPACK_IMPORTED_MODULE_1__]);
_AfishaMap__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];





(0,_CustomDatepicker__WEBPACK_IMPORTED_MODULE_2__.initCustomDatePicker)();
(0,_CustomSelect__WEBPACK_IMPORTED_MODULE_3__.initCustomSelectComponents)();
const map = new _AfishaMap__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector('[data-js-yandex-map]'));
new _AfishaFilterForm__WEBPACK_IMPORTED_MODULE_0__.AfishaFilterForm(map);
__webpack_async_result__();
} catch(e) { __webpack_async_result__(e); } });
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "loveforever:";
