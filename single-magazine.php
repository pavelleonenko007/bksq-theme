								...
								<div class="content-block ms5-content-block">
									<div class="ms5-box cursor-hover scrollobs">
										...
										<div class="ms5-image-row">
											<?php
											while ( have_rows( 'otryvok_2___izobrazheniya', false ) ) :
												the_row();
												?>
									...
									<div class="ms5-box cursor-hover scrollobs">
										...
										<div class="ms5-image-row">
											<?php
											while ( have_rows( 'otryvok_3___izobrazheniya', false ) ) :
												the_row();
												?>
											<div class="ms5-image ms5-image-double"><img class="image-cover" src="<?php echo get_sub_field( 'foto' ); ?>" alt="" loading="lazy"></div>
											<?php endwhile; ?>
									...
									<div class="ms5-box cursor-hover scrollobs">
										...
										<div class="ms5-image-row">
											<?php
											while ( have_rows( 'otryvok_4___izobrazheniya', false ) ) :
												the_row();
												?>
											<div class="ms5-image ms5-image-double"><img class="image-cover" src="<?php echo get_sub_field( 'foto' ); ?>" alt="" loading="lazy"></div>
											<?php endwhile; ?>
									...
									<div class="ms5-box cursor-hover scrollobs">
										...
										<div class="ms5-image-row">
											<?php
											while ( have_rows( 'otryvok_5___izobrazheniya', false ) ) :
												the_row();
												?>
											<div class="ms5-image ms5-image-double"><img class="image-cover" src="<?php echo get_sub_field( 'foto' ); ?>" alt="" loading="lazy"></div>
											<?php endwhile; ?>
						...
						<section class="section">
							<div class="vimeo-cursor-hover">
								<div data-w-id="3b21dbcf-607c-b553-4500-0e2ad8e6b99e" class="container full-width-container">
									...
									<?php
									$link = get_field( 'linkonvideo', false );
									if ( ! empty( $link ) ) :
												$url    = $link['url'];
												$title  = $link['title'];
												...
												<script>
													window.locations = [
														...
														if ( have_rows( 'karta_tochki_prodazh' ) ) :
															while ( have_rows( 'karta_tochki_prodazh' ) ) :
																the_row();
																?>
								...
								<div class="content-block magazine-s6-content-block scrollobs visible">
									...
									<div class="ms6-right">
										...
										<div class="ms6-link-wrap">
											<?php
											while ( have_rows( 'tochki_prodazh_pod_kartoj', false ) ) :
												the_row();
												?>
							...
							<div class="container">
								...
								<div class="content-block ms7-content-block scrollobs visible">
									<div class="ms7-left">
										...
										<?php endif; ?><a href="<?php echo esc_url( 'mailto:' . get_field( 'email_opc', 'option' ) ); ?>" class="text-18 is-link">
										<?php
										if ( ! empty( get_field( 'email_opc', 'option' ) ) ) :
											?>
											<span><?php echo get_field( 'email_opc', 'option' ); ?></span><?php endif; ?></a>
									</div>
									<div class="ms7-right">
					...
					<div data-lenis-prevent="" class="see-all-popup">
						...
						<div class="see-all-popup-inner">
							...
							<div class="see-all-grid">
								<?php
								while ( have_rows( 'popuplinks', false ) ) :
									the_row();
									?>
								<div id="w-node-_929622b3-614d-6665-096f-61246073a472-6073a471" class="see-all-box"><img src="<?php echo get_sub_field( 'imgpopupbuy' ); ?>" loading="lazy" alt="" class="image-contain">
									<?php
									$link = get_sub_field( 'linkpopupbuy' );
									if ( ! empty( $link ) ) :
											$url    = $link['url'];
											$title  = $link['title'];
											$target = $link['target'] ? $link['target'] : '_self';
